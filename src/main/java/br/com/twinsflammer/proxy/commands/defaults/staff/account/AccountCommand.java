package br.com.twinsflammer.proxy.commands.defaults.staff.account;

import br.com.twinsflammer.proxy.commands.defaults.staff.account.arguments.AccountChangeDiscordIdCommand;
import br.com.twinsflammer.proxy.commands.defaults.staff.account.arguments.AccountChangeEmailCommand;
import br.com.twinsflammer.proxy.commands.defaults.staff.account.arguments.AccountChangePasswordCommand;
    ...
    public void onCommand(User user, String[] args) {
        ...
        if (user1.getGroups().isEmpty()) {
            ...
            List<UserGroup> groups = Lists.newArrayList(
                    userGroupDao.findAll(user1.getId(), "")
            );
