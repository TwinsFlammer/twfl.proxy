...
public class AccountCommand extends CustomCommand {
    ...
    public void onCommand(User user, String[] args) {
        ...
        jsonText.next()
                ...
                .text("\n")
                .next()
                .text("§6Informações sobre o usuário ")
                .next()
        ...
        jsonText.next()
                ...
                .text("\n")
                .next()
                .text("  Proxy: " + (user1.isOnline() ? user1.getProxyId() : "Indisponível"))
                .next()
                .text("\n")
                .next()
                .text("  Servidor: " + (user1.isOnline() ? user1.getServer().getDisplayName() : "Indisponível"))
                .next()
                .text("\n")
                .next()
                .send(user);
